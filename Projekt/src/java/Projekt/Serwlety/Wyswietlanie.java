 ...
 * @author student
 */
@WebServlet(name = "Wyswietlanie", urlPatterns = {"/Wyswietlanie"})
public class Wyswietlanie extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<title>List of PPT files</title>");            
            out.println("</head>");
            out.println("<body>");     
            out.println("<h3>List of ppt files on server</h3>");
            
            out.println(new Hiber.PptQuery().showPptList());
